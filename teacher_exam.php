                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="add_exam.php" class="btn btn-info"><i class="icon-plus-sign"></i> Add Exam</a>
									<td width="30"><a href="add_exam_to_class.php" class="btn btn-success"><i class="icon-plus-sign"></i> Add Exam to Class</a></td>   
									</div>
									...
									<?php include('modal_delete_exam.php'); ?>
										<thead>
										        <tr>
												<th></th>
												<th>Exam title</th>
									...
									?>                              
										...
										<td width="30">
                                         ...
                                         <td><a href="exam_question.php<?php echo '?id='.$id; ?>">Questions</a></td>                                      
                                         <td width="30"><a href="edit_exam.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i></a></td>                                                                         
										</tr>
									<?php } ?>
										</tbody>
									</table>
