                                ...
                                <div class="span12">
									...
									<a href="teacher_exam.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" name="exam_title" id="inputEmail" placeholder="Exam Title">
											</div>
										</div>
										<div class="control-group">
										...
										mysqli_query($conn,"insert into exam (exam_title,exam_description,date_added,teacher_id) values('$exam_title','$description',NOW(),'$session_id')")or die(mysqli_error());
										?>
										<script>
